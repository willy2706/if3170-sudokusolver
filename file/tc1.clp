...
(defrule grid-values
   ...
   (assert (possible (row 2) (column 3) (value any) (diagonal 6)(group 1) (id 6)))     
   ...
   (assert (possible (row 1) (column 6) (value 2) (diagonal 2)(group 2) (id 9)))
   ...
   (assert (possible (row 2) (column 6) (value 4) (diagonal 10)(group 2) (id 12)))

   (assert (possible (row 3) (column 1) (value any) (diagonal 11)(group 3) (id 13)))
   ...
   (assert (possible (row 4) (column 2) (value 5) (diagonal 14)(group 3) (id 17)))
   (assert (possible (row 4) (column 3) (value 6) (diagonal 2)(group 3) (id 18)))  
   ...
   (assert (possible (row 4) (column 5) (value 3) (diagonal 17)(group 4) (id 23)))
   (assert (possible (row 4) (column 6) (value any) (diagonal 18)(group 4) (id 24)))
   
   (assert (possible (row 5) (column 1) (value 5) (diagonal 19)(group 5) (id 25)))
   ...
   (assert (possible (row 6) (column 4) (value 1) (diagonal 25)(group 6) (id 34)))
